...
PARAM$experimento <- "HT4510_prueba2"
...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.001, upper = 0.01),
  makeNumericParam("feature_fraction", lower = 0.2, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 500L, upper = 2000L),
  makeIntegerParam("num_leaves", lower = 64L, upper = 1024L),
  makeIntegerParam("envios", lower = 9500L, upper = 12500L)
)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    lambda_l1 = 0.5, # por ahora, lo dejo fijo
