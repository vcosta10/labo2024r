...
PARAM <- list()
PARAM$experimento <- "KA4540_nueva"
...
PARAM$finalmodel$num_iterations <- 1423
PARAM$finalmodel$learning_rate <- 0.00872789618195966
PARAM$finalmodel$feature_fraction <- 0.92069315793924
PARAM$finalmodel$min_data_in_leaf <- 761
